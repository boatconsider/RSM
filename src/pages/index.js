...
<button onClick={() => router.push("/information")} className="  text-cyan-400 ">คลิกดูรายละเอียดการใช้งานเพิ่มเติม</button>
  ...
  <div class="bg-white rounded-lg p-4 w-[300px] h-[300px]">
    ...
    <button  onClick={() => router.push("/cut")} className="  text-cyan-400 ">คลิกที่นี้</button>
    </div>
  ...
  <div className="flex justify-center items-center flex-col">
    ...
    <button onClick={() => router.push("/move")} className="  text-cyan-400 ">คลิกที่นี้</button>
    </div>
  ...
  <div className="flex justify-center items-center flex-col">
    ...
    <button onClick={() => router.push("/edit")}  className="  text-cyan-400 ">คลิกที่นี้</button>
    </div>
